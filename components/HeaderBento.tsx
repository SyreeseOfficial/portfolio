             ...
             <div className="flex flex-col md:flex-row h-full relative z-10">
                ...
                <div className="p-8 flex flex-col justify-center md:w-3/5 border-b md:border-b-0 border-white/5 bg-transparent">
                   <div className="flex items-center gap-5 mb-6">
                      <div className="w-16 h-16 rounded-full bg-gradient-to-br from-white/10 to-white/5 border border-white/10 flex items-center justify-center shrink-0 shadow-2xl backdrop-blur-sm overflow-hidden">
                        <img src="syreese.png" alt="Syreese DS" className="w-full h-full object-cover" />
                      </div>
                      <div>
                         <div className="text-[10px] font-bold tracking-widest text-[#ff3131] uppercase mb-1">Builder</div>
                         <h2 className="text-2xl font-bold text-white tracking-tight">Syreese DS</h2>
                      </div>
                   </div>
