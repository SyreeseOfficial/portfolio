      ...
      <div className="flex flex-col">
        ...
        >
           <div className="pl-4 md:pl-0 font-sans text-sm text-grey leading-relaxed space-y-4">
             <p>
               I'm a builder at heart. Whether it's pouring concrete or writing React components, I love the process of creating something from nothing.
             </p>
             <p>
               This portfolio is a collection of my work, my thoughts, and the things that inspire me. It's a living document of my journey from the job site to the web.
             </p>
           </div>
        </DashboardModule>
