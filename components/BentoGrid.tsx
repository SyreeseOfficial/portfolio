...
import { Users, MousePointer2, Dumbbell, Star, BarChart3, Mic } from 'lucide-react';
...
export const BentoGrid: React.FC = () => {
  ...
  const getIcon = (type: string) => {
    switch (type) {
      ...
      case 'voice': return <Mic className={`${iconClass} text-white/40 group-hover:text-white/60 transition-colors`} />;
  ...
  return (
    <section className="mb-32">
      <h2 className="text-2xl md:text-3xl font-bold mb-10 text-white/90">Working On</h2>
            ...
            <GlassCard className="h-full relative overflow-hidden group" hoverEffect={false}>
              ...
              <div className="p-5 md:p-6 h-full flex flex-col relative z-10">
                ...
                <div className="flex flex-col h-full">
                  <div className="mb-3">
                    <h3 className="text-lg md:text-xl font-bold text-white group-hover:text-[#ffbd59] transition-colors mb-1">
                      {item.title}
                    </h3>
                  </div>
