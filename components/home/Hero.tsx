        ...
        <div>
          ...
          >
            <a
              ...
              className="inline-flex items-center gap-2 bg-electricBlue text-white font-sans font-medium px-8 py-3 rounded-md hover:bg-electricBlueDark transition-colors duration-200"
            >
              <Download size={18} />
              Download Resume
            </a>
